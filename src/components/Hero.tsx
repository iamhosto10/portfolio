        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h1 className="mt-6 animate-in fade-in slide-in-from-bottom duration-700 delay-100 text-5xl font-black tracking-tight text-foreground md:text-7xl">
              Gerardo{" "}
              <span className="block text-black dark:bg-linear-to-r dark:from-blue-400 dark:to-purple-600 dark:bg-clip-text dark:text-transparent lg:inline">
                Ramírez
              </span>
            </h1>
          ...
          <div className="flex justify-center animate-in zoom-in-95 duration-1000">
            <div className="relative">
              <div className="absolute -inset-1 rounded-3xl bg-linear-to-r from-blue-600 to-purple-600 opacity-30 blur-2xl dark:opacity-40"></div>
              <Image
