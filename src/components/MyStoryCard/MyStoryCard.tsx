...
export default function MyStoryCard() {
  return (
    <div className="container max-w-5xl mx-auto px-6 md:px-16 py-10">
      <Card className="border shadow-xl rounded-xl border-muted/50 dark:shadow-primary/10 p-6 sm:p-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
        ...
        <CardContent className="p-0 space-y-4">
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            I believe that great software is not just about writing lines of
            code, but about solving real problems and creating intuitive
            experiences. My journey has taught me that continuous learning and
            attention to detail are the keys to building products that users
            truly love.
          </p>
        </CardContent>
      </Card>
